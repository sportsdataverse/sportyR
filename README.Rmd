...
units_df = data.frame(
  sport = c('Baseball', 'Basketball', 'Basketball', 'Basketball', 'Basketball', 'Football', 'Football', 'Football', 'Hockey', 'Hockey', 'Hockey', 'Hockey', 'Soccer', 'Soccer', 'Soccer', 'Soccer', 'Soccer'),
  league = c('MLB', 'FIBA', 'NBA', 'NCAA Basketball', 'WNBA', 'CFL', 'NCAA Football', 'NFL', 'IIHF', 'NCAA Hockey', 'NHL', 'NWHL', 'FIFA', 'MLS', 'NCAA Soccer', 'NWSL', 'Premier League'),
  primary_unit = c('`ft`', '`m`', '`ft`', '`ft`', '`ft`', '`yd`', '`yd`', '`yd`', '`m`', '`ft`', '`ft`', '`ft`', '`m`', '`m`', '`m`', '`m`', '`m`')
)
