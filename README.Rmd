...
[![Codecov test coverage](https://codecov.io/gh/rossdrucker/sportyR/branch/master/graph/badge.svg)](https://codecov.io/gh/rossdrucker/sportyR?branch=master)
...
You can install the released version of `sportyR` from [GitHub](https://github.com/rossdrucker/sportyR) with:
