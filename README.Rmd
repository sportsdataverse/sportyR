...
This repository contains code necessary to draw scale versions of playing surfaces to visualize play-by-play data for baseball, basketball, curling, football, hockey, soccer, softball and tennis in **R**. For the **Python** version of this package, click [here](https://github.com/sportsdataverse/sportypy).
...
-   `geom_baseball()` and `geom_softball()` are displayed from the high-home 
    view by default, as base/softball coordinates typically have the `+y` axis 
    extending from the back tip of home plate towards center field
