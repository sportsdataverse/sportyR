...
You can install `sportyR` from [GitHub](https://github.com/rossdrucker/sportyR) with:
...
The main functionality of plotting is intended to be straightforward and easy to use. However, questions are sure to arise about what can and can't be plotted and customized in the current version of the package. The `cani_` family of functions are here to help answer those questions directly. Their syntax is meant to resemble a question like
