...
- `color_updates`: A list that contains updates to the features’ colors
  ...
  can change, try running
  [`cani_color_league_features()`](https://sportyR.sportsdataverse.org/reference/cani_color_league_features.md)
...
- [`geom_baseball()`](https://sportyR.sportsdataverse.org/reference/geom_baseball.md)
  is displayed from the high-home view by default, as baseball
...
![plot of chunk
readme-display-range-demo](reference/figures/README-readme-display-range-demo-1.png)

plot of chunk readme-display-range-demo
...
![plot of chunk
readme-display-range-curling-demo](reference/figures/README-readme-display-range-curling-demo-1.png)

plot of chunk readme-display-range-curling-demo
...
Additionally, the
[`convert_units()`](https://sportyR.sportsdataverse.org/reference/convert_units.md)
function can be called on a data frame to convert from the data’s
arguments to the plot’s. For example, if soccer data is given in yards,
but is desirable to be plotted in meters, calling
...
`y` ***column*** via the
[`rotate_coords()`](https://sportyR.sportsdataverse.org/reference/rotate_coords.md)
function. Reflection is also possible through
[`reflect()`](https://sportyR.sportsdataverse.org/reference/reflect.md).
...
![plot of chunk
readme-mlb-example](reference/figures/README-readme-mlb-example-1.png)

plot of chunk readme-mlb-example
...
![plot of chunk
readme-fifa-example](reference/figures/README-readme-fifa-example-1.png)

plot of chunk readme-fifa-example
...
![plot of chunk
readme-nhl-example](reference/figures/README-readme-nhl-example-1.png)

plot of chunk readme-nhl-example
...
A printable one-page reference for `sportyR` — every surface function
and the arguments that shape it — is available as a free PDF:

📄 **[Download the sportyR cheat sheet
(PDF)](https://sportsdataverse.org/cheatsheets/sportyR.pdf)**

Light and dark, US Letter landscape. Every SportsDataverse package has
one — browse them all at
...
`citation("sportyR")` returns this entry with the installed version
number attached.
