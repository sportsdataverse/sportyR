...
basketball, curling, football, hockey, soccer, softball and tennis in
**R**. For the **Python** version of this package, click
...
- `geom_baseball()` and `geom_softball()` are displayed from the
  high-home view by default, as base/softball coordinates typically have
  the `+y` axis extending from the back tip of home plate towards center
  field
...
<img src="man/figures/README-readme-display-range-demo-1.png" alt="" width="100%" />
...
<img src="man/figures/README-readme-display-range-curling-demo-1.png" alt="" width="100%" />
...
<img src="man/figures/README-readme-mlb-example-1.png" alt="" width="100%" />
...
<img src="man/figures/README-readme-fifa-example-1.png" alt="" width="100%" />

``` r
# Draw a regulation NCAA softball infield plot
geom_softball(league = "NCAA", display_range = "infield")
#> Coordinate system already present.
#> ℹ Adding new coordinate system, which will replace the existing one.
```

<img src="man/figures/README-readme-softball-example-1.png" alt="" width="100%" />
...
<img src="man/figures/README-readme-nhl-example-1.png" alt="" width="100%" />
