...
ncaa_soccer_feature_grass = function(touchline_length,
                                     goal_line_length,
                                     full_surf = TRUE,
                                     rotate = FALSE,
                                     rotation_dir = "ccw") {
...
#'   touchlines
ncaa_soccer_feature_touchlines = function(touchline_length,
                                          goal_line_length,
                                          full_surf = TRUE,
                                          rotate = FALSE,
                                          rotation_dir = "ccw") {
...
ncaa_soccer_feature_goal_line = function(touchline_length,
                                         goal_line_length,
                                         full_surf = TRUE,
                                         rotate = FALSE,
                                         rotation_dir = "ccw") {
...
ncaa_soccer_feature_halfway_line = function(goal_line_length,
                                            full_surf = TRUE,
                                            rotate = FALSE,
                                            rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
...
ncaa_soccer_feature_center_circle = function(full_surf = TRUE,
                                             rotate = FALSE,
                                             rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
  x = y = NULL
...
#'   quarter-circles
ncaa_soccer_feature_corner_circle = function(touchline_length,
                                             goal_line_length,
                                             full_surf = TRUE,
                                             rotate = FALSE,
                                             rotation_dir = "ccw") {
...
ncaa_soccer_feature_box_5.5m = function(touchline_length,
                                        full_surf = TRUE,
                                        rotate = FALSE,
                                        rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
...
ncaa_soccer_feature_box_9.15m = function(touchline_length,
                                         full_surf = TRUE,
                                         rotate = FALSE,
                                         rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
...
ncaa_soccer_feature_penalty_arc = function(touchline_length,
                                           full_surf = TRUE,
                                           rotate = FALSE,
                                           rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
...
ncaa_soccer_feature_penalty_mark = function(touchline_length,
                                            full_surf = TRUE,
                                            rotate = FALSE,
                                            rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
...
ncaa_soccer_feature_center_mark = function(touchline_length,
                                           full_surf = TRUE,
                                           rotate = FALSE,
                                           rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
...
ncaa_soccer_feature_goal = function(touchline_length,
                                    full_surf = TRUE,
                                    rotate = FALSE,
                                    rotation_dir = 'ccw') {
  # Initialize x and y (to pass checks)
...
geom_ncaa_soccer = function(touchline_length = 120,
  ...
  box_5.5m = ncaa_soccer_feature_box_5.5m(touchline_length, full_surf, rotate, rotation_dir)
  box_9.15m = ncaa_soccer_feature_box_9.15m(touchline_length, full_surf, rotate, rotation_dir)
