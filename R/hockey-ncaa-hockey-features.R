...
#' Generate the list of colors for an NCAA rink plot. The defaults can be
#' overwritten by supplying the names of the list elements to the
#' \code{geom_ncaa_hockey()} function (or its wrapper \code{geom_hockey()})
#'
...
#' Create a ggplot2 instance that represents a regulation NCAA hockey rink, with
#' the center of the rink corresponding to (0, 0)
#'
...
#'   colors to pass to the \code{ncaa_hockey_features_set_colors()} function
#'
...
geom_ncaa_hockey = function(full_surf = TRUE,
  ...
  # Create the colors to use for the plot
  color_list = ncaa_hockey_features_set_colors(...)

  # Generate the data frames for the features of an NCAA rink
  boards = ncaa_hockey_feature_boards(full_surf, rotate, rotation_dir)
  center_line = ncaa_hockey_feature_center_line(full_surf, rotate, rotation_dir)
  blue_line = ncaa_hockey_feature_blue_line(full_surf, rotate, rotation_dir)
  goal_line = ncaa_hockey_feature_goal_line(full_surf, rotate, rotation_dir)
  goal_crease = ncaa_hockey_feature_goal_crease(full_surf, rotate, rotation_dir)
  ...
  for (spot in 1:length(faceoff_spots)) {
    ...
    faceoff_spot = ncaa_hockey_feature_faceoff_spot(center, full_surf, rotate, rotation_dir)
    faceoff_circle = ncaa_hockey_feature_faceoff_circle(center, full_surf, rotate, rotation_dir)
