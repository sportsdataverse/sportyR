...
ncaa_tennis_feature_court_background = function(full_surf = TRUE, rotate = FALSE, rotation_dir = 'ccw'){
...
ncaa_tennis_feature_baseline = function(full_surf = TRUE, rotate = FALSE, rotation_dir = 'ccw'){
...
#'   sideline(s)
ncaa_tennis_feature_doubles_sideline = function(full_surf = TRUE, rotate = FALSE, rotation_dir = 'ccw'){
...
#' @return A data frame containing the points that comprise the doubles
#'   sideline(s)
ncaa_tennis_feature_singles_sideline = function(full_surf = TRUE, rotate = FALSE, rotation_dir = 'ccw'){
...
ncaa_tennis_feature_service_line = function(full_surf = TRUE, rotate = FALSE, rotation_dir = 'ccw'){
...
#'   line(s)
ncaa_tennis_feature_center_service_line = function(full_surf = TRUE, rotate = FALSE, rotation_dir = 'ccw'){
...
ncaa_tennis_feature_center_mark = function(full_surf = TRUE, rotate = FALSE, rotation_dir = 'ccw'){
...
#'
#' @return A data frame containing the points that comprise the center mark(s)
ncaa_tennis_feature_net = function(full_surf = TRUE, rotate = FALSE, rotation_dir = 'ccw'){
...
#' Generate the list of colors for an NCAA tennis court plot. The defaults can be
#' overwritten by supplying the names of the list elements to the
#' \code{geom_ncaa_tennis()} function (or its wrapper \code{geom_tennis()})
#'
...
#'   resulting plot
ncaa_tennis_features_set_colors = function(court_background_color = '#196f0c',
...
#' Create a ggplot2 instance that represents a regulation NCAA tennis court, with
...
#'   colors to pass to the \code{ncaa_tennis_features_set_colors()} function
#'
#' @return A ggplot2 instance that represents a regulation NFL field
geom_ncaa_tennis = function(full_surf = TRUE,
                            rotate = FALSE,
                            rotation_dir = 'ccw',
                            unit = 'ft',
  ...
  # Create the colors to use for the plot
  color_list = ncaa_tennis_features_set_colors(...)

  # Generate the data frames for the features of an NCAA tennis court
  court_background = ncaa_tennis_feature_court_background(full_surf, rotate, rotation_dir)
  baseline = ncaa_tennis_feature_baseline(full_surf, rotate, rotation_dir)
  doubles_sideline = ncaa_tennis_feature_doubles_sideline(full_surf, rotate, rotation_dir)
  singles_sideline = ncaa_tennis_feature_singles_sideline(full_surf, rotate, rotation_dir)
  service_line = ncaa_tennis_feature_service_line(full_surf, rotate, rotation_dir)
  center_service_line = ncaa_tennis_feature_center_service_line(full_surf, rotate, rotation_dir)
  center_mark = ncaa_tennis_feature_center_mark(full_surf, rotate, rotation_dir)
  net = ncaa_tennis_feature_net(full_surf, rotate, rotation_dir)
