...
ncaa_tennis_feature_court_background = function(full_surf = TRUE,
                                                rotate = FALSE,
                                                rotation_dir = "ccw") {
...
ncaa_tennis_feature_baseline = function(full_surf = TRUE,
                                        rotate = FALSE,
                                        rotation_dir = "ccw") {
...
#'   sideline(s)
ncaa_tennis_feature_doubles_sideline = function(full_surf = TRUE,
                                                rotate = FALSE,
                                                rotation_dir = "ccw") {
...
#' @return A data frame containing the points that comprise the doubles
#'   sideline(s)
ncaa_tennis_feature_singles_sideline = function(full_surf = TRUE,
                                                rotate = FALSE,
                                                rotation_dir = "ccw") {
...
ncaa_tennis_feature_service_line = function(full_surf = TRUE,
                                            rotate = FALSE,
                                            rotation_dir = "ccw") {
...
#'   line(s)
ncaa_tennis_feature_center_service_line = function(full_surf = TRUE,
                                                   rotate = FALSE,
                                                   rotation_dir = "ccw") {
...
ncaa_tennis_feature_center_mark = function(full_surf = TRUE,
                                           rotate = FALSE,
                                           rotation_dir = "ccw") {
...
#'
#' @return A data frame containing the points that comprise the center mark(s)
ncaa_tennis_feature_net = function(full_surf = TRUE,
                                   rotate = FALSE,
                                   rotation_dir = "ccw") {
