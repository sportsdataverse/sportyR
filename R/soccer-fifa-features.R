...
fifa_feature_grass = function(touchline_length,
                              goal_line_length,
                              full_surf = TRUE,
                              rotate = FALSE,
                              rotation_dir = "ccw") {
...
#'   touchlines
fifa_feature_touchlines = function(touchline_length,
                                   goal_line_length,
                                   full_surf = TRUE,
                                   rotate = FALSE,
                                   rotation_dir = "ccw") {
...
fifa_feature_goal_line = function(touchline_length,
                                  goal_line_length,
                                  full_surf = TRUE,
                                  rotate = FALSE,
                                  rotation_dir = "ccw") {
...
fifa_feature_halfway_line = function(goal_line_length,
                                     full_surf = TRUE,
                                     rotate = FALSE,
                                     rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
...
fifa_feature_center_circle = function(full_surf = TRUE,
                                      rotate = FALSE,
                                      rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
  x = y = NULL
...
#'   quarter-circles
fifa_feature_corner_circle = function(touchline_length,
                                      goal_line_length,
                                      full_surf = TRUE,
                                      rotate = FALSE,
                                      rotation_dir = "ccw") {
...
fifa_feature_box_5.5m = function(touchline_length,
                                 full_surf = TRUE,
                                 rotate = FALSE,
                                 rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
...
fifa_feature_box_9.15m = function(touchline_length,
                                  full_surf = TRUE,
                                  rotate = FALSE,
                                  rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
...
fifa_feature_penalty_arc = function(touchline_length,
                                    full_surf = TRUE,
                                    rotate = FALSE,
                                    rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
...
fifa_feature_penalty_mark = function(touchline_length,
                                     full_surf = TRUE,
                                     rotate = FALSE,
                                     rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
...
fifa_feature_center_mark = function(touchline_length,
                                    full_surf = TRUE,
                                    rotate = FALSE,
                                    rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
...
fifa_feature_goal = function(touchline_length,
                             full_surf = TRUE,
                             rotate = FALSE,
                             rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
