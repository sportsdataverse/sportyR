...
fifa_feature_box_6yd = function(touchline_length, full_surf = TRUE, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
fifa_feature_box_18yd = function(touchline_length, full_surf = TRUE, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
geom_fifa = function(touchline_length = 120,
  ...
  box_6yd = fifa_feature_box_6yd(touchline_length, full_surf, rotate, rotation_dir)
  box_18yd = fifa_feature_box_18yd(touchline_length, full_surf, rotate, rotation_dir)
