...
fifa_feature_grass = function(touchline_length, goal_line_length, full_surf = TRUE, rotate = FALSE, rotation_dir = 'ccw'){
...
#'   touchlines
fifa_feature_touchlines = function(touchline_length, goal_line_length, full_surf = TRUE, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
fifa_feature_goal_line = function(touchline_length, goal_line_length, full_surf = TRUE, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
fifa_feature_halfway_line = function(goal_line_length, full_surf = TRUE, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
fifa_feature_center_circle = function(full_surf = TRUE, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
#'   quarter-circles
fifa_feature_corner_circle = function(touchline_length, goal_line_length, full_surf = TRUE, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
fifa_feature_box_5.5m = function(touchline_length, full_surf = TRUE, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
fifa_feature_box_9.15m = function(touchline_length, full_surf = TRUE, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
fifa_feature_penalty_arc = function(touchline_length, full_surf = TRUE, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
fifa_feature_penalty_mark = function(touchline_length, full_surf = TRUE, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
fifa_feature_center_mark = function(touchline_length, full_surf = TRUE, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
fifa_feature_goal = function(touchline_length, full_surf = TRUE, rotate = FALSE, rotation_dir = TRUE){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
#' Generate the list of colors for a FIFA pitch plot. The defaults can be
#' overwritten by supplying the names of the list elements to the
#' \code{geom_fifa()} function (or its wrapper \code{geom_soccer()})
#'
...
#'   resulting plot
fifa_features_set_colors = function(grass_color = '#196f0c',
...
#' Create a ggplot2 instance that represents a regulation FIFA pitch, with the
...
#'   colors to pass to the \code{fifa_features_set_colors()} function
#'
#' @return A ggplot2 instance that represents a regulation FIFA pitch
geom_fifa = function(touchline_length = 120,
                     goal_line_length = 90,
                     full_surf = TRUE,
                     rotate = FALSE,
                     rotation_dir = 'ccw',
  ...
  # Create the colors to use for the plot
  color_list = fifa_features_set_colors(...)

  # Generate the data frames for the features of a FIFA pitch
  grass = fifa_feature_grass(touchline_length, goal_line_length, full_surf, rotate, rotation_dir)
  touchlines = fifa_feature_touchlines(touchline_length, goal_line_length, full_surf, rotate, rotation_dir)
  goal_line = fifa_feature_goal_line(touchline_length, goal_line_length, full_surf, rotate, rotation_dir)
  halfway_line = fifa_feature_halfway_line(goal_line_length, full_surf, rotate, rotation_dir)
  center_circle = fifa_feature_center_circle(full_surf, rotate, rotation_dir)
  corner_circle = fifa_feature_corner_circle(touchline_length, goal_line_length, full_surf, rotate, rotation_dir)
  box_5.5m = fifa_feature_box_5.5m(touchline_length, full_surf, rotate, rotation_dir)
  box_9.15m = fifa_feature_box_9.15m(touchline_length, full_surf, rotate, rotation_dir)
  penalty_arc = fifa_feature_penalty_arc(touchline_length, full_surf, rotate, rotation_dir)
  penalty_mark = fifa_feature_penalty_mark(touchline_length, full_surf, rotate, rotation_dir)
  center_mark = fifa_feature_center_mark(touchline_length, full_surf, rotate, rotation_dir)
  goal = fifa_feature_goal(touchline_length, full_surf, rotate, rotation_dir)
