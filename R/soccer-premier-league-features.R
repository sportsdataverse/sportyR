...
#' Generate the list of colors for a Premier League pitch plot. The defaults can
#' be overwritten by supplying the names of the list elements to the
#' \code{geom_premier_league()} function (or its wrapper \code{geom_soccer()})
#'
...
#'
#' @return A ggplot2 instance that represents a regulation Premier League pitch
geom_premier_league = function(touchline_length = 120,
                               goal_line_length = 90,
                               full_surf = TRUE,
                               rotate = FALSE,
                               rotation_dir = "ccw",
  ...
  # Generate the data frames for the features of a Premier League pitch
  grass = premier_league_feature_grass(touchline_length, goal_line_length, full_surf, rotate, rotation_dir)
  touchlines = premier_league_feature_touchlines(touchline_length, goal_line_length, full_surf, rotate, rotation_dir)
  goal_line = premier_league_feature_goal_line(touchline_length, goal_line_length, full_surf, rotate, rotation_dir)
