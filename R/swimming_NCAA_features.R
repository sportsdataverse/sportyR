...
NCAA_swimmng_feature_deck = function(course = "SCY", lane_width = 2, number_of_lanes = 8, overflow_channels = 1, rotate = FALSE, rotation_dir = 'ccw'){
...
NCAA_swimmng_feature_pool = function(course = "SCY", lane_width = 3, number_of_lanes = 8, overflow_channels = 1, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
NCAA_swimmng_feature_15m_start_line = function(course = "SCY", lane_width = 3, number_of_lanes = 8, overflow_channels = 1, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
NCAA_swimmng_feature_15m_start_markers = function(course = "SCY", lane_width = 3, number_of_lanes = 8, overflow_channels = 1, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
  ...
  m15_markers_fun <- function(centerline, pool_length, mark_thickness) {
    df = create_rectangle(
...
NCAA_swimmng_feature_15m_turn_line = function(course = "SCY", lane_width = 3, number_of_lanes = 8, overflow_channels = 1, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
NCAA_swimmng_feature_15m_turn_markers = function(course = "SCY", lane_width = 3, number_of_lanes = 8, overflow_channels = 1, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
NCAA_swimmng_feature_flags_start = function(course = "SCY", lane_width = 3, number_of_lanes = 8, overflow_channels = 1, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
...
NCAA_swimmng_feature_flags_start_string = function(course = "SCY", lane_width = 3, number_of_lanes = 8, overflow_channels = 1, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
...
NCAA_swimmng_feature_flags_turn = function(course = "SCY", lane_width = 3, number_of_lanes = 8, overflow_channels = 1, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
NCAA_swimmng_feature_flags_turn_string = function(course = "SCY", lane_width = 3, number_of_lanes = 8, overflow_channels = 1, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
NCAA_swimmng_feature_lane_markers = function(course = "SCY", lane_width = 3, number_of_lanes = 8, overflow_channels = 1, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
NCAA_swimmng_feature_lane_markers_cross_start = function(course = "SCY", lane_width = 3, number_of_lanes = 8, overflow_channels = 1, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
NCAA_swimmng_feature_lane_markers_cross_turn = function(course = "SCY", lane_width = 3, number_of_lanes = 8, overflow_channels = 1, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
NCAA_swimmng_feature_blocks = function(course = "SCY", lane_width = 3, number_of_lanes = 8, overflow_channels = 1, rotate = FALSE, rotation_dir = 'ccw'){
  # Initialize x and y (to pass checks)
  x = y = NULL
...
NCAA_swimmng_feature_lane_lines = function(course = "SCY", lane_width = 3, number_of_lanes = 8, overflow_channels = 1, rotate = FALSE, rotation_dir = 'ccw'){
...
NCAA_swimmng_feature_lane_lines_start = function(course = "SCY", lane_width = 3, number_of_lanes = 8, overflow_channels = 1, rotate = FALSE, rotation_dir = 'ccw'){
...
NCAA_swimmng_feature_lane_lines_turn = function(course = "SCY", lane_width = 3, number_of_lanes = 8, overflow_channels = 1, rotate = FALSE, rotation_dir = 'ccw'){
...
NCAA_swimmng_feature_lane_line_strings = function(course = "SCY", lane_width = 3, number_of_lanes = 8, overflow_channels = 1, rotate = FALSE, rotation_dir = 'ccw'){
  ...
  if(rotate){
    # If the desired output needs to be rotated, rotate the coordinates
    lane_line_strings = rotate_coords(
      lane_line_strings,
      rotation_dir
    )
  }
...
#'   resulting plot
NCAA_swimmng_features_set_colors = function(deck_color = 'grey',
                                        pool_color = 'blue',
...
#'   colors to pass to the \code{NCAA_swimmng_features_set_colors()} function
#'
#' @return A ggplot2 instance that represents a regulation pool
geom_NCAA_swimmng = function(course,
                             lane_width = 3,
                             number_of_lanes = 8,
                             overflow_channels = 1.5,
                             rotate = FALSE,
  ...
  # Create the colors to use for the plot
  color_list = NCAA_swimmng_features_set_colors(...)

  # Generate the data frames for the features of a pool + deck
  deck = NCAA_swimmng_feature_deck(course, lane_width, number_of_lanes, overflow_channels, rotate, rotation_dir)
  pool = NCAA_swimmng_feature_pool(course, lane_width, number_of_lanes, overflow_channels, rotate, rotation_dir)
  m15_start = NCAA_swimmng_feature_15m_start_line(course, lane_width, number_of_lanes, overflow_channels, rotate, rotation_dir)
  m15_markers_start = NCAA_swimmng_feature_15m_start_markers(course, lane_width, number_of_lanes, overflow_channels, rotate, rotation_dir)
  m15_turn = NCAA_swimmng_feature_15m_turn_line(course, lane_width, number_of_lanes, overflow_channels, rotate, rotation_dir)
  m15_markers_turn = NCAA_swimmng_feature_15m_turn_markers(course, lane_width, number_of_lanes, overflow_channels, rotate, rotation_dir)
  flags_start = NCAA_swimmng_feature_flags_start(course, lane_width, number_of_lanes, overflow_channels, rotate, rotation_dir)
  flags_turn = NCAA_swimmng_feature_flags_turn(course, lane_width, number_of_lanes, overflow_channels, rotate, rotation_dir)
  flags_start_string = NCAA_swimmng_feature_flags_start_string(course, lane_width, number_of_lanes, overflow_channels, rotate, rotation_dir)
  flags_turn_string = NCAA_swimmng_feature_flags_turn_string(course, lane_width, number_of_lanes, overflow_channels, rotate, rotation_dir)
  lane_markers = NCAA_swimmng_feature_lane_markers(course, lane_width, number_of_lanes, overflow_channels, rotate, rotation_dir)
  lane_markers_cross_start = NCAA_swimmng_feature_lane_markers_cross_start(course, lane_width, number_of_lanes, overflow_channels, rotate, rotation_dir)
  lane_markers_cross_turn = NCAA_swimmng_feature_lane_markers_cross_turn(course, lane_width, number_of_lanes, overflow_channels, rotate, rotation_dir)
  blocks = NCAA_swimmng_feature_blocks(course, lane_width, number_of_lanes, overflow_channels, rotate, rotation_dir)
  lane_lines = NCAA_swimmng_feature_lane_lines(course, lane_width, number_of_lanes, overflow_channels, rotate, rotation_dir)
  lane_lines_start = NCAA_swimmng_feature_lane_lines_start(course, lane_width, number_of_lanes, overflow_channels, rotate, rotation_dir)
  lane_lines_turn = NCAA_swimmng_feature_lane_lines_turn(course, lane_width, number_of_lanes, overflow_channels, rotate, rotation_dir)
  lane_line_strings = NCAA_swimmng_feature_lane_line_strings(course, lane_width, number_of_lanes, overflow_channels, rotate, rotation_dir)
