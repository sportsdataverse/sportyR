...
#'
#' @param df The dataframe to reflect. It must have \code{x} and \code{y}
#'   columns
...
#'
#' @param df The dataframe to translate It must have \code{x} and \code{y}
#'   columns
#' @param translate_x The number of units (in the input dataframe's units) to
#'   translate the points in the +x direction. Default: 0
#' @param translate_y The number of units (in the input dataframe's units) to
