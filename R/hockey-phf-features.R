...
phf_feature_boards = function(full_surf = TRUE,
                               rotate = FALSE,
                               rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
  x = y = NULL

  # PHF boards are 200' long and 85' wide, with corners rounded at an arc of
  # 28 feet
...
phf_feature_center_line = function(full_surf = TRUE,
                                    rotate = FALSE,
                                    rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
  x = y = NULL
...
phf_feature_blue_line = function(full_surf = TRUE,
                                  rotate = FALSE,
                                  rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
  x = y = NULL
...
phf_feature_goal_line = function(full_surf = TRUE,
                                  rotate = FALSE,
                                  rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
  x = y = NULL
...
#'   restricted area
phf_feature_goalkeepers_restricted_area = function(full_surf = TRUE,
                                                    rotate = FALSE,
                                                    rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
  x = y = NULL
...
phf_feature_goal_crease = function(full_surf = TRUE,
                                    rotate = FALSE,
                                    rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
  x = y = NULL
...
phf_feature_referee_crease = function(full_surf = TRUE,
                                       rotate = FALSE,
                                       rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
  x = y = NULL
...
phf_feature_faceoff_spot = function(center = c(0, 0),
                                     full_surf = TRUE,
                                     rotate = FALSE,
                                     rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
  ...
  # The center dot on an PHF ice rink is 1' in diameter
...
phf_feature_faceoff_circle = function(center = c(0, 0),
                                       full_surf = TRUE,
                                       rotate = FALSE,
                                       rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
  ...
  if (identical(center, c(0, 0))) {
    # The center circle on an PHF ice rink is 15' in diameter
...
phf_feature_faceoff_lines = function(center = c(0, 0),
                                      full_surf = TRUE,
                                      rotate = FALSE,
                                      rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
...
phf_feature_goal = function(full_surf = TRUE,
                             rotate = FALSE,
                             rotation_dir = "ccw") {
  # Initialize x and y (to pass checks)
  x = y = NULL
...
#' Generate the list of colors for an PHF rink plot. The defaults can be
#' overwritten by supplying the names of the list elements to the
#' \code{geom_phf()} function (or its wrapper \code{geom_hockey()})
#'
...
#'   resulting plot
phf_features_set_colors = function(boards_color = "#000000",
...
#' Create a ggplot2 instance that represents a regulation PHF rink, with the
...
#'   colors to pass to the \code{phf_features_set_colors()} function
#'
#' @return A ggplot2 instance that represents a regulation PHF rink
geom_phf = function(full_surf = TRUE,
                     rotate = FALSE,
                     rotation_dir = "ccw",
                     unit = "ft",
  ...
  # Create the colors to use for the plot
  color_list = phf_features_set_colors(...)

  # Generate the data frames for the features of an NHL rink
  boards = phf_feature_boards(full_surf, rotate, rotation_dir)
  center_line = phf_feature_center_line(full_surf, rotate, rotation_dir)
  blue_line = phf_feature_blue_line(full_surf, rotate, rotation_dir)
  goal_line = phf_feature_goal_line(full_surf, rotate, rotation_dir)
  goalkeepers_restricted_area = phf_feature_goalkeepers_restricted_area(full_surf, rotate, rotation_dir)
  goal_crease = phf_feature_goal_crease(full_surf, rotate, rotation_dir)
  referee_crease = phf_feature_referee_crease(full_surf, rotate, rotation_dir)
  goal = phf_feature_goal(full_surf, rotate, rotation_dir)
  ...
  for (spot in 1:length(faceoff_spots)) {
    ...
    faceoff_spot = phf_feature_faceoff_spot(center, full_surf, rotate, rotation_dir)
    faceoff_circle = phf_feature_faceoff_circle(center, full_surf, rotate, rotation_dir)
    faceoff_lines = phf_feature_faceoff_lines(center, full_surf, rotate, rotation_dir)
