...
- gap_width:
  ...
  The width of the gap from the inner edge of the non-centered faceoff
  spot ring to the outer edge of the stripe
...
This function is responsible for creating the inner stripe, not the
colored outer ring around it. Please see
[`hockey_nodzone_faceoff_spot_ring()`](https://sportyR.sportsdataverse.org/reference/hockey_nodzone_faceoff_spot_ring.md)
